...
# Run-IntegrationTests.ps1 compares it against every broker address a device is given --
# BrokerHost in each config\<device>.json, and the broker constants compiled into the
# device and integration-test projects -- and warns when they have drifted apart.
#
